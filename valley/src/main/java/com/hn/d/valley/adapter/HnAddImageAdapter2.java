 ...
 * Version: 1.0.0
 */
public class HnAddImageAdapter2 extends HnGlideImageAdapter {
    ...
    public HnAddImageAdapter2(Context context) {
        super(context);
    }

    public HnAddImageAdapter2(Context context, List<Luban.ImageItem> datas) {
        super(context, datas);
    }
    ...
    protected void onBindView(RBaseViewHolder holder, final int position, final Luban.ImageItem bean) {
        ...
        if (isAddModel && bean == null && isLast(position)) {
            imageView.setImageResource(R.drawable.add_fabudongtai);
