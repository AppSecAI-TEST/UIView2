...
public class Regex {
    ...
    public static final String TITLE_PATTERN2 = "<title>(.*?)</title>";
    ...
    public static final String URL_PATTERN2 = "((http|ftp|https):\\/\\/)?[\\w\\-_]+(\\.[\\w\\-_]+)+([\\w\\-\\.,@?^=%&amp;:/~\\+#]*[\\w\\-\\@?^=%&amp;/~\\+#])?";

//    ex @"<title>(.*?)</title>"
//            #define WebImageRegex @"<img[\\s\\S]*?src=\"(.*?)\"[^>]*>"
