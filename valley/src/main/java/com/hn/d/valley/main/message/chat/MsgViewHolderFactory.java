...
import com.hn.d.valley.main.message.chat.viewholder.MsgVHShareNews;
import com.hn.d.valley.main.message.chat.viewholder.MsgVHShowChampion;
...
public class MsgViewHolderFactory {
    ...
    static {
        ...
        register(ShareNewsAttachment.class, MsgVHShareNews.class);
        ...
        register(OnlineVideoForwardAttachment.class, MsgVHOnlineVideo.class);
        register(ShowChampionAttachment.class, MsgVHShowChampion.class);
