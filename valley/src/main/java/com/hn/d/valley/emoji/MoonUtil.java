...
public class MoonUtil {
     ...
     * 表情处理
     */
    public static void show(Context context, View textView, String value) {
        // 显示消息具体内容
        MoonUtil.identifyFaceExpressionAndTags(context, textView, value, ImageSpan.ALIGN_BOTTOM, 0.45f);
    }
