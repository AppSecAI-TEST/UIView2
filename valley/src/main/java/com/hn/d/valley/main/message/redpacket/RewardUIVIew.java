...
public class RewardUIVIew extends ItemRecyclerUIView<ItemRecyclerUIView.ViewItemInfo> {
    ...
    public RewardUIVIew(String avatar , String uid) {
        this.uid = uid;
        this.avatar = avatar;
    }
    ...
    protected void createItems(List<ViewItemInfo> items) {
        ...
        items.add(ViewItemInfo.build(new ItemCallback() {
            ...
            public void onBindView(RBaseViewHolder holder, int posInData, ViewItemInfo dataBean) {
                ...
                ImageView iv_refresh = holder.imgV(R.id.iv_refresh);
...
//                        .create());
    ...
    private void perfromClick(EditText etMoney ,WalletAccount account) {
