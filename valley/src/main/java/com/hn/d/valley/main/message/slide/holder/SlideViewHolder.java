...
import com.hn.d.valley.main.message.slide.helper.SlideAnimationHelper;

/**
 * Created by zhan on 2017/2/6.
 */

public abstract class SlideViewHolder extends RBaseViewHolder implements ISlide {
    ...
    public SlideViewHolder(View itemView, int viewType) {
