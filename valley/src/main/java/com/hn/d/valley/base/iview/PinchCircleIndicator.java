 ...
 */
public class PinchCircleIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public PinchCircleIndicator(Context context) {
        this(context, null);
    }

    public PinchCircleIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PinchCircleIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
