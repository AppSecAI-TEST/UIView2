        ...
        for (Map.Entry<TeamFieldEnum, Object> field : a.getUpdatedFields().entrySet()) {
            if (field.getKey() == TeamFieldEnum.Name) {
                ...
                if (type == VerifyTypeEnum.Free) {
                    sb.append(authen + ValleyApp.getApp().getString(R.string.team_allow_anyone_join));
                } else if (type == VerifyTypeEnum.Apply) {
                    sb.append(authen + ValleyApp.getApp().getString(R.string.team_need_authentication));
                } else {
                    sb.append(authen + ValleyApp.getApp().getString(R.string.team_not_allow_anyone_join));
                }
