...
public class FriendDataCache {
    ...
    private Observer<FriendChangedNotify> friendChangedNotifyObserver = new Observer<FriendChangedNotify>() {
        ...
        public void onEvent(FriendChangedNotify friendChangedNotify) {
            ...
            if (!myFriendAccounts.isEmpty()) {
                ...
                // log
                DataCacheManager.Log(myFriendAccounts, "on add friends", "FRIEND_CACHE");
            }
            ...
            if (!deletedFriendAccounts.isEmpty()) {
                ...
                // log
                DataCacheManager.Log(deletedFriendAccounts, "on delete friends", "FRIEND_CACHE");
    ...
    private Observer<BlackListChangedNotify> blackListChangedNotifyObserver = new Observer<BlackListChangedNotify>() {
        ...
        public void onEvent(BlackListChangedNotify blackListChangedNotify) {
            ...
            if (!addedAccounts.isEmpty()) {
                ...
                // log
                DataCacheManager.Log(addedAccounts, "on add users to black list", "FRIEND_CACHE");
            ...
            if (!removedAccounts.isEmpty()) {
                ...
                // log
                DataCacheManager.Log(removedAccounts, "on remove users from black list", "FRIEND_CACHE");
    ...
    public void buildCache() {
        ...
        // 排除掉自己
        accounts.remove(UserCache.getUserAccount());

        // 确定缓存
        friendAccountSet.addAll(accounts);

        L.i("build FriendDataCache completed, friends count = " + friendAccountSet.size());
    }
