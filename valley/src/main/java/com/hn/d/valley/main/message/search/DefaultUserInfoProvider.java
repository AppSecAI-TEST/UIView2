...
//    }
    ...
    private DefaultUserInfoProvider() {}

    private static class Holder {
        private static DefaultUserInfoProvider sInstance = new DefaultUserInfoProvider();
    }

    public static DefaultUserInfoProvider getInstance() {
