...
public class MagicAmaroFilter extends GPUImageFilter {
	...
	public MagicAmaroFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.amaro));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils2.loadTexture(mContext, "filter/brannan_blowout.png");
				inputTextureHandles[1] = OpenGLUtils2.loadTexture(mContext, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGLUtils2.loadTexture(mContext, "filter/amaromap.png");
		    }
	    });
	}
}
