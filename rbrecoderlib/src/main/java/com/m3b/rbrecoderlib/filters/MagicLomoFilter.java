...
public class MagicLomoFilter extends GPUImageFilter {
	...
	public MagicLomoFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.lomo));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils2.loadTexture(mContext, "filter/lomomap_new.png");
				inputTextureHandles[1] = OpenGLUtils2.loadTexture(mContext, "filter/vignette_map.png");
		    }
	    });
	}
}
