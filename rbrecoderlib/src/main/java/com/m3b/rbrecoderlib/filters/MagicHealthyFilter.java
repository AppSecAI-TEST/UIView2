...
public class MagicHealthyFilter extends GPUImageFilter{
	...
	public MagicHealthyFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.healthy));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils2.loadTexture(mContext, "filter/healthy_mask_1.jpg");
		    }
	    });
	}
