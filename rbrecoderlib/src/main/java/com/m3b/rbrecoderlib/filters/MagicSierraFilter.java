...
public class MagicSierraFilter extends GPUImageFilter {
	...
	public MagicSierraFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.sierra));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils2.loadTexture(mContext, "filter/sierravignette.png");
				inputTextureHandles[1] = OpenGLUtils2.loadTexture(mContext, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGLUtils2.loadTexture(mContext, "filter/sierramap.png");
		    }
	    });
	}
}