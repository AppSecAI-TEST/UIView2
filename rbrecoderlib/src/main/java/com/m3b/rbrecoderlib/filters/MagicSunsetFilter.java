...
public class MagicSunsetFilter extends GPUImageFilter {
	...
	public MagicSunsetFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.sunset));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils2.loadTexture(mContext, "filter/rise_mask1.jpg");
		        mMaskGrey2TextureId = OpenGLUtils2.loadTexture(mContext, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
