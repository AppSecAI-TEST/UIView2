...
public class MagicSweetsFilter extends GPUImageFilter {
	...
	public MagicSweetsFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.sweets));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils2.loadTexture(mContext, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
