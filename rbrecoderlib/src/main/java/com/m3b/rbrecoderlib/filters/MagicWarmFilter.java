...
public class MagicWarmFilter extends GPUImageFilter {
	...
	public MagicWarmFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.warm));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils2.loadTexture(mContext, "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = OpenGLUtils2.loadTexture(mContext, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
