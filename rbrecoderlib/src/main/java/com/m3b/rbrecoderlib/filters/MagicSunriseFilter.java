...
public class MagicSunriseFilter extends GPUImageFilter {
	...
	public MagicSunriseFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGLUtils2.readShaderFromRawResource(context, R.raw.sunrise));
		mContext = context;
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
		        mMaskGrey1TextureId = OpenGLUtils2.loadTexture(mContext, "filter/amaro_mask1.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
		        mMaskGrey2TextureId = OpenGLUtils2.loadTexture(mContext, "filter/amaro_mask2.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
		        mMaskGrey3TextureId = OpenGLUtils2.loadTexture(mContext, "filter/toy_mask1.jpg");
		    }
	    });
	}
}
