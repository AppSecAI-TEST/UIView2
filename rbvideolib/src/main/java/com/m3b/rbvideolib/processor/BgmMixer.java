...
import com.m3b.rbvideolib.listener.BgmMixerListener;
...
public class BgmMixer {
    ...
    public BgmMixer(Activity activity){
        a = activity;
    ...
    public void execCommand(String[] cmd, final BgmMixerListener mListener){
        try {
