package com.m3b.rbvideolib.util;
...
public class AppUtils {
    ...
    public static String getFormatTime(long msTime ){
        long duration = msTime / 1000;
        long starthours = duration / 3600;
        long startminutes = (duration - starthours * 3600) / 60;
        long startseconds = duration - (starthours * 3600 + startminutes * 60);
    ...
    public static long getVideoLength(String path) {
        ...
        //7680
        try {
            _videoLength = Long.valueOf(time).longValue()/1000;
        } catch (Exception e) {
            e.printStackTrace();
            _videoLength = 0;
        }
